...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/animal", "/api/animal/*").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/animal/*").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/animal/*").permitAll()
