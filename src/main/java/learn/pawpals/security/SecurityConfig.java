...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/animal").hasAnyRole("foster_parent")
                .antMatchers(HttpMethod.PUT, "/api/animal/*").hasAnyRole("foster_parent")
                .antMatchers(HttpMethod.DELETE, "/api/animal/*").hasAnyRole("foster_parent")
                .antMatchers("/**").denyAll()
                .and()
